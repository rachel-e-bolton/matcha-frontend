<template>
  <div>
    ...
    <br/><br/>  
    Matcha ("us", "we", or "our") operates the www.matchame.co.za website and the Matcha mobile application (the "Service").
    <br/><br/> 
    This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy for Matcha is created with the help of the Free Privacy Policy Generator.
    <br/><br/> 
    ...
    <br/><br/> 
    Email address, First name and last name, Phone number, Cookies and Usage Data and Usage Data.
    <br/><br/> 
    ...
    <br/><br/> 
    Matcha uses the collected data for various purposes:
    <br/><br/> 
    ...
    <br/><br/> 
    Matcha will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.
    <br/><br/> 
    <strong>Disclosure Of Data:</strong>
    <br/><br/> 
    <strong>Legal Requirements</strong>
    <br/><br/> 
    Matcha may disclose your Personal Data in the good faith belief that such action is necessary to:
    <br/><br/> 
    • To comply with a legal obligation
    <br/>
    • To protect and defend the rights or property of Matcha
    <br/>
    • To prevent or investigate possible wrongdoing in connection with the Service
    <br/>
    • To protect the personal safety of users of the Service or the publicTo protect against legal liability
    <br/><br/> 
